...
def id_exists(user_id):
    try:
        f = open("/home/shamim/Desktop/ML/Banking_Managemet_System/user_information.txt", "r")
        for line in f:
...
def read_users():
    users = []
    try:
        with open("/home/shamim/Desktop/ML/Banking_Managemet_System/user_information.txt", "r") as f:
            for line in f:
                if line.strip():
...
def write_users(users):
    with open("/home/shamim/Desktop/ML/Banking_Managemet_System/user_information.txt", "w") as f:
        for user in users:
            f.write(str(user) + "\n")
...
def Creat_account():
    ...
    f = open("/home/shamim/Desktop/ML/Banking_Managemet_System/user_information.txt", "a")
    f.write(str(data) + "\n")
    f.close()
...
def Transection_history():
    ...
    transactions = []
    try:
        with open("/home/shamim/Desktop/ML/Banking_Managemet_System/Transfer.txt", "r") as f:
            for line in f:
                if line.strip():
...
def payment_history():
    ...
    transactions = []
    try:
        with open("/home/shamim/Desktop/ML/Banking_Managemet_System/Report.txt", "r") as f:
            for line in f:
                if line.strip():
                    transactions.append(ast.literal_eval(line.strip()))
    except FileNotFoundError:
...
def Payment():
    ...
    for user in users:
        if user[0] == user_id and user[1] == password:
            ...
            f = open("/home/shamim/Desktop/ML/Banking_Managemet_System/Report.txt", "a")
            f.write(str(data) + "\n")
            f.close()
...
def Send_money():
    ...
    for user in users:
        if user[0] == user_id and user[1] == password:
            ...
            f = open("/home/shamim/Desktop/ML/Banking_Managemet_System/Transfer.txt", "a")
            f.write(str(data) + "\n")
            f.close()
            print("Payment successfully!")
            recevied  = read_users()
...
def Admin():
    ...
    flag = False
    with open("/home/shamim/Desktop/ML/Banking_Managemet_System/Admin_Information.txt", "r") as f:
     for line in f:
